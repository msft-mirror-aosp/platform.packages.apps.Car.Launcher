...
public class ControlBarMediaFragment extends MediaCardFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        mControlBarController =
                (ControlBarMediaController) new ControlBarMediaController.Builder().setModels(
                        mViewModel.getPlaybackViewModel(), mViewModel,
                        mViewModel.getMediaItemsRepository()).setViewGroup(
                        (ViewGroup) view).build();
    }
}
